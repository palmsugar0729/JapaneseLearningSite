...
> 版本：v2.6（✅ 已上线 2026-09-15）
> 日期：2026-09-15
> 上一版本：v2.5.1（2026-09-05）
>
...
> ¹ 隐私政策按本站**实际收集的数据**起草（用户名、密码哈希、微信 openid、学习进度、错题记录、busuanzi 统计、localStorage）；**备案主体名称仍为页面上的待补占位**。
...
- ⏳ 遗留：`fill` / `reading` 题库数据未整理；隐私政策备案主体名称待补
